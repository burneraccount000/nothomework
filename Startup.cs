...
using Ramirez_Mackenzie_HW4.DAL;


namespace Ramirez_Mackenzie_HW4
{
    public class Startup
    {
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            String connectionString = "Server=tcp:sp22ramirezmackenziehw3.database.windows.net,1433;Initial Catalog=sp22ramirezmackenziehw4;Persist Security Info=False;User ID=MISAdmin;Password=Password123!;MultipleActiveResultSets=True;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
